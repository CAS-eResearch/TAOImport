...
class DARKSAGEConverter(tao.Converter):
    ...
    def __init__(self, *args, **kwargs):
        src_fields_dict = OrderedDict([
                ('StellarMass', {
                        ...
                        'units': "10^10 Msun/h",
                        'group': "Galaxy Integrated Masses",
                        'order': 0,
                        }),
                ('BulgeMass', {
                        'type': np.float32,
               ...
               ('TotSfr', {
                ...
                ('Len', {
                 ...
                 ('LenMax', {
                      ...
                      'description': "Maximum number of simulation particles in the dark matter subhalo over its entire existence up until this point",
                      'group': "Halo Properties",
                      'order': 33,
                  }),
                ('CentralMvir', {
    ...
    def get_extra_fields(self):
        ...
        wanted_field_keys = [
            ...
            'Vpeak',
             ...
             'DiscGasMetalsMetals_1', 'DiscGasMetals_2', 'DiscGasMetals_3', 'DiscGasMetals_4', 'DiscGasMetals_5', 'DiscGasMetals_6', 'DiscGasMetals_7', 'DiscGasMetals_8', 'DiscGasMetals_9', 'DiscGasMetals_10', 'DiscGasMetals_11', 'DiscGasMetals_12', 'DiscGasMetals_13', 'DiscGasMetals_14', 'DiscGasMetals_15', 'DiscGasMetals_16', 'DiscGasMetals_17', 'DiscGasMetals_18', 'DiscGasMetals_19', 'DiscGasMetals_20', 'DiscGasMetals_21', 'DiscGasMetals_22', 'DiscGasMetals_23', 'DiscGasMetals_24', 'DiscGasMetals_25', 'DiscGasMetals_26', 'DiscGasMetals_27', 'DiscGasMetals_28', 'DiscGasMetals_29', 'DiscGasMetals_30',
    ...
    def totHI(self, tree):
        val = 0
        for i in range(1,31): val += tree['DiscHI_'+str(i)]
        return val

    def totH2(self, tree):
        val = 0
        for i in range(1,31): val += tree['DiscH2_'+str(i)]
        return val
    ...
    def iterate_trees(self):
        ...
        computed_fields = {'TotSfr': self.totsfr, 'Vpeak': self.Vpeak, 'HImass': self.totHI, 'H2mass': self.totH2}
        computed_field_list = []
        ...
        assert from_file_dtype.itemsize == 3472, "Size of datatypes do not match"
